...
@cross_origin()
def list_holidays():
    holidays = Holiday.query.all()  # Fetch all holidays from the database
    holidays_list = [holiday.to_dict() for holiday in holidays]  # Convert holidays to a list of dictionaries
    return jsonify(holidays_list), 200
